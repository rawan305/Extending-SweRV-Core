...
HD_PWD='C:/Users/nimro/VivadoProjects/Cores-SweRV_fpga/hardware/project/script/eh1_zedboard/eh1_zedboard.runs/clk_and_rst_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_and_rst_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_and_rst_clk_wiz_0_1.tcl
