...
HD_PWD='C:/Users/nimro/VivadoProjects/Cores-SweRV_fpga/hardware/project/script/eh1_zedboard/eh1_zedboard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log swerv_eh1_reference_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source swerv_eh1_reference_design.tcl -notrace
