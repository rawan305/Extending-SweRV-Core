...
HD_PWD='C:/Users/nimro/VivadoProjects/Cores-SweRV_fpga/hardware/project/script/eh1_zedboard/eh1_zedboard.runs/axi_intc_auto_rs_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_intc_auto_rs_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_intc_auto_rs_0.tcl
