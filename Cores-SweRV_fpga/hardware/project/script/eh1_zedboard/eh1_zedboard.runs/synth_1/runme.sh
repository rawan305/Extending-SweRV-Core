...
HD_PWD='C:/Users/nimro/VivadoProjects/Cores-SweRV_fpga/hardware/project/script/eh1_zedboard/eh1_zedboard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swerv_eh1_reference_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swerv_eh1_reference_design.tcl
