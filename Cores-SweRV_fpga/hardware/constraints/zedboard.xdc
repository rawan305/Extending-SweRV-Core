...
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { jtag_tdo }]; #
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { jtag_trst_n }]; #
set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports { jtag_tck}]; #
...
set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { jtag_tdi }]; #
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { jtag_tms }]; #
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { jtag_nrst }]; #
...
set_property -dict { PACKAGE_PIN D11    IOSTANDARD LVCMOS33 } [get_ports { uart_rxd }]; #
set_property -dict { PACKAGE_PIN C14    IOSTANDARD LVCMOS33 } [get_ports { uart_txd }]; #
